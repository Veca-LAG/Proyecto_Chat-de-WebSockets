// ── ACCIONES SOBRE MENSAJES: ELIMINACIÓN, REENVÍO Y DESHACER ────────────────

const DELETED_FOR_ME_KEY = 'ola_deleted_for_me';

// Dependencias inyectadas una vez via initMessageActions()
let _state = null;
let _sendJson = null;
...
/**
 * Inyecta las dependencias de nivel de aplicación.
 * Debe llamarse en initApp(), antes de cualquier renderMessage().
 *
 * @param {{
 *   state: object,
 *   sendJson: function,
 *   renderActiveChatMessages: function,
 *   applyConversationSearch: function,
...
/**
 * Muestra el modal de eliminación estilo WhatsApp.
 * Requiere que initMessageActions() haya sido llamado primero.
 *
 * @param {object}      message
 * @param {HTMLElement} messageElement
 * @param {string}      [messageKind='private']
...
// ── Actualizar burbuja cuando el servidor confirma eliminación ──────────────

/**
 * Marca un mensaje como eliminado para todos en el DOM y en el estado local.
 * Requiere que initMessageActions() haya sido llamado primero.
 *
 * @param {string} id
 * @param {string} deletedBy  userId de quien eliminó.
 */
